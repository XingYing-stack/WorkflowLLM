...
The pruning process optimizes and refines the generated data produced by the Annotator, ensuring higher quality and relevance. To perform pruning, you can run the provided script as follows:
